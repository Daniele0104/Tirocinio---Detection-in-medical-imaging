...
def main():
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(images, labels)):
        ...
        fold_dir = os.path.join(f"C:/Tirocinio/DEIMv2/folds_ALLP_k{k}", f"fold_{fold}")
    ...
    save_coco_annotations(metadata, f"C:/Tirocinio/DEIMv2/folds_ALLP_k{k}/metadata.json")
